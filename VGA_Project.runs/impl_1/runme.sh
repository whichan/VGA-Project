...
HD_PWD='D:/project/systemveriog_2/VGA_Project/VGA_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_VGA_OV7670.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_VGA_OV7670.tcl -notrace
