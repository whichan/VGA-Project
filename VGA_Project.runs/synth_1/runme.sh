...
HD_PWD='D:/project/systemveriog_2/VGA_Project/VGA_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_VGA_OV7670.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_VGA_OV7670.tcl
